...
print()
print(f'expected TH (A) product_generator: {len(I) * len(M) * len(T_TH)}')
print(f' - expected TH (A) product_generator (spiro): {len(I) * len(spiro) * len(T_TH)}')
print(f' - expected TH (A) product_generator (fused): {len(I) * len(fused) * len(T_TH)}')
print(f' - expected TH (A) product_generator (sub): {len(I) * len(sub) * len(T_TH)}')
print()
print(f'expected ABT (A) product_generator: {len(I) * len(M) * len(T_ABT)}')
print(f' - expected ABT (A) product_generator (spiro): {len(I) * len(spiro) * len(T_ABT)}')
print(f' - expected ABT (A) product_generator (fused): {len(I) * len(fused) * len(T_ABT)}')
print(f' - expected ABT (A) product_generator (sub): {len(I) * len(sub) * len(T_ABT)}')
