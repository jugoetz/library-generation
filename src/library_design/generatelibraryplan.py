...
initiator_shorts = [
    f"I{i + 1}" for i in range(len(compounds.loc[compounds["Category"] == "I"]))
]
monomer_shorts = [
    f"M{i + 1}" for i in range(len(compounds.loc[compounds["Category"] == "M"]))
]
terminator_shorts = [
    f"T{i + 1}" for i in range(len(compounds.loc[compounds["Category"] == "T"]))
]
...
print(
    f"Each initiator will be used in {initiators_average} reactions on average. "
...
print(
    f"Each monomer will be used in {monomers_average} reactions on average. "
...
print(
    f"Each terminator will be used in {terminators_average} reactions on average. "
...
product_set = [
    [i, m, t] for i in initiator_sets for m in monomers_sets for t in terminators_sets
]
